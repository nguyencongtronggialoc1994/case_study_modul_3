...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{route('admin.productDetail.index')}}">
                Product Detail
            </a>
        </li>
        <li class="nav-item">
...
{{--        </li>--}}
        ...
        <div class="sidebar-card">
            <img class="sidebar-card-illustration mb-2" src="{{asset('back_end/img/undraw_rocket.svg')}}" alt="">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- Topbar -->
            <nav style="background-color: #2a3238;color: white"
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"
                      method="post" action="{{route('admin.product.search')}}">
                    @csrf
                    <div class="input-group">
                        <input name="productName" type="text" class="form-control bg-light border-0 small"
