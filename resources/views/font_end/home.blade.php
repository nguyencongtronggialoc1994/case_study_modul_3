                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                                <div class="single-product">
                                                        ...
                                                        <div class="button-head">
                                                            <div class="product-action">
                                                                <a  data-target="#exampleModal"
                                                                   title="Quick View" href="{{route('home.showDetail',$products[$i]->id)}}"><i class="ti-search"></i><span>Chi tiết sản phẩm</span></a>

                                                            </div>
                                                            <div class="product-action-2">
                                                                    <a href="{{route('cart.addToCart',$products[$i]->id)}}"  class="btn btn-fefault add-to-cart">
                                                    ...
                                                    <div class="product-content">
                                                        <h3>
                                                            <a href="product-details.html">{{$products[$i]->productName}}</a>
                                                        </h3>
                        ...
                        @for($i=0;$i<4;$i++)
                            <div class="single-product">
                                <div class="product-img">
                                    ...
                                    <div class="button-head">
                                        <div class="product-action">
                                            <a  data-target="#exampleModal" title="Quick View"
                                               href="{{route('home.showDetail',$products[$i]->id)}}"><i class="ti-search"></i><span>Chi tiết sản phẩm</span></a>
                                        </div>
                                        <div class="product-action-2">
